  ...
  return (
    <div className={`bg-gray-800 text-white transition-all duration-300 ${isOpen ? 'w-64' : 'w-10'} flex-shrink-0`}>
      ...
      <ul className="flex flex-col">
        <li className="px-2 py-2 hover:bg-gray-600 cursor-pointer flex items-center" onClick={handleOnClickGrounds}>
        <svg className="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
          ...
          {isOpen && <span>Grounds</span>}
        </li>
        <li className="px-2 py-2 hover:bg-gray-600 cursor-pointer flex items-center" onClick={handleOnClickuser}>
          <FaUsers className="mr-2" size={24}/>
          {isOpen && <span>Users</span>}
        </li>
        <li className="px-2 py-2 hover:bg-gray-600 cursor-pointer flex items-center">
          <FaCog className="mr-2" size={24}/>
