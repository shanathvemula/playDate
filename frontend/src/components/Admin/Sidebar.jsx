    ...
    return (
        <div className={`bg-white dark:bg-gray-800 text-black dark:text-white transition-all duration-300 ${isOpen ? 'w-64' : 'w-10'} flex-shrink-0`}>
            ...
            <ul className="flex flex-col">
                <li
                    className="px-2 py-2 hover:bg-sky-500 cursor-pointer flex items-center"
                    onClick={handleOnClickGrounds}
                    {...(!isOpen && { 'data-tooltip-id': 'tooltip', 'data-tooltip-content': 'Grounds' })} // Conditionally add tooltip
                >
                ...
                <li
                    ...
                    {...(!isOpen && { 'data-tooltip-id': 'tooltip', 'data-tooltip-content': 'Users' })}
                >
                    <FaUsers size={24} />
